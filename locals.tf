locals {
  ...
  policy_definition = try(data.azurerm_policy_set_definition.this[0], data.azurerm_policy_definition.this[replace(var.policy_definition_id, local.regex_pattern_id_to_name, "")])
  ...
  policy_definition_names = [for id in local.policy_definition_ids : replace(id, local.regex_pattern_id_to_name, "")] #name is last part of id
